# this sample was moved here for a better debugging experience from:
[planner sample ](https://github.com/MicrosoftDocs/semantic-kernel-docs/tree/main/samples/dotnet/04-Planner)
# Using planner
